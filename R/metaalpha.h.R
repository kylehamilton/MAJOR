...
metaAlphaOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaAlphaOptions",
...
metaAlphaResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaAlphaResults",
...
metaAlphaBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaAlphaBase",
