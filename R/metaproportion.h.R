...
metaProportionOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
metaProportionResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaProportionResults",
...
metaProportionBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaProportionBase",
