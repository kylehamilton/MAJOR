...
metaAnalysisCorrOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
...
metaAnalysisCorrResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "metaAnalysisCorrResults",
...
metaAnalysisCorrBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
